...
\item
  deriving aderbs: \obj{-ke} `\gl{prop}'
\end{itemize}
...
\gl{1+3}) distinction, though the 1+2 pronoun \obj{ejnë} does not have
...
be noted that \obj{-kontomo}, which appears on the second person plural
...
occurrence of bound \obj{u-} `\gl{1}' on members of all three parts of
speech is illustrated in \exref[]{1marking}; \exref[]{2marking}
illustrates the same distribution for \obj{më-} `\gl{2}'.
