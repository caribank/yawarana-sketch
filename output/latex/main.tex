...
\midrule
    Identification &                                              N + N &                              N + N + \emph{pïnirë} \\
    Categorization &                                              N + N &                           (N +?) N + \emph{pïnirë} \\
Permanent property &     \gl{adv} + N + \gl{cop} <br> \gl{adv}\obj{-mï} &                                  N + \emph{pïnirë} \\
Temporary property &                                              N + N &                             N + \gl{adv}\obj{-jra} \\
          Location &                                       \gl{loc} + N & N + \gl{loc} + \emph{pïnirë} N + \obj{akërë} `w... \\
       Existential & N + \emph{mïntë} \emph{entë} + N \emph{mëtë} + ... & \emph{pïrarë} + N\obj{-jra} N + \emph{entë} + \... \\
        Possession &       N\obj{-ke} + \gl{cop} <br> \gl{adv}\obj{-mï} &                               N\obj{-ke}\obj{-jra} \\
\bottomrule
\end{tabular}
...
N + \emph{pïnirë}, see \exref[]{conv1stenc-80}.
...
N + \obj{akërë} `with' + \gl{cop}-\gl{neg} + N:
...
\label{hist2mape-58}    \begingl
    ...
    \glb too =\gl{restr} \gl{3}:father:\gl{pos}-\gl{prop}-\gl{neg}//
