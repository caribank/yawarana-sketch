...
\label{convrisamaj-09}    \begingl
    ...
    \glb \gl{3}\gl{pro} \gl{contrast} \gl{ints} \gl{3}-\gl{pl} tell-\gl{ipfv} on.surface-\gl{nmlz} thus \gl{3}-\gl{pl} do-\gl{ipfv} there.\gl{loc} ***//
...
\label{convrisamaj-13}    \begingl
    ...
    \glb nothing see.self-\gl{ipfv}-\gl{neg} \gl{1+2}\gl{pro} ***//
...
\label{convrisamaj-29}    \begingl
    ...
    \glb good see.self-\gl{ipfv}-\gl{neg} *** \gl{1+2}\gl{pro} \gl{dat} good see.self-\gl{ipfv}-\gl{neg} *** \gl{1+2}\gl{pro} *** ***//
...
\label{ctorat-30}    \begingl
    ...
    \glb go.in.group-\gl{pst}-\gl{pl} thus then nothing//
