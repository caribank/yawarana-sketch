...
\glb who \gl{part} \gl{lk}-with \gl{1+2}\gl{pro} talk-\gl{ipfv} \gl{1+2}\gl{pro} alone aunt//
...
\glb what \gl{1+2}\gl{pro} laugh-\gl{ipfv}//
...
\glb \gl{1}\gl{pro} see-\gl{neg} like \gl{emp}//
